...
?>
  ...
  <div class="col-md-4">
        ...
        <!-- <a href='loaderslinkedin.php' class='btn btn-sm btn-primary'>Linkedin Students</a> -->
...
// if(isset($_POST['showstudentlist'])){
 if (isset($_COOKIE["sidss"])){
    ...
    // $studlistobtain=array_unique($studlistobtain);
        ...
        // echo $studlistobtain[1];
            ...
            if ($result ->num_rows >0) {
                ...
                while($row1 = $result->fetch_assoc()) {
                    ...
                    <td contenteditable="false"  ><?php echo $row1["resume"];?></td>
...
// -----maintaining the time gap between two uploads-----
 ...
 function setSource() {
     ...
     function showcvform(x,y){
         console.log(x,y);
         var hrf1 = ['loaders_form/form.php?jid='+y, x];
         hrf=hrf1;
         setSource();
         $('.df2').toggle();
         $('.df3').toggle();
     ...
     function authorisedStudent(sid){
         console.log(sid);
                           ...
                           $.ajax({
                                url: 'loaders_form/authorisedStud.php',
                                type: 'POST',
                                data: {param1:sid},
                                dataType:"json",
                                success:function(){   
